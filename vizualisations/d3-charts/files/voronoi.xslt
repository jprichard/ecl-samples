<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="Dataset[starts-with(@name,'VoronoiTesselation')]" mode="generate_body">
        <h1><xsl:value-of select="translate(substring-after(@name, 'VoronoiTesselation_'),'_',' ')"/></h1>
...
function update() {
  ...
  svg.selectAll("circle")
    ...
    <xsl:template match="Dataset[starts-with(@name,'VoronoiTesselation')]" mode="generate_script">
	</xsl:template>
</xsl:stylesheet>